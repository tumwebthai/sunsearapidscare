...
export const metadata: Metadata = {
  title: `รับส่งสนามบินภูเก็ต | ${SITE_NAME}`,
  description: 'บริการรถรับส่งสนามบินภูเก็ต พร้อมคนขับ ราคาเหมาจ่าย สนามบินภูเก็ต→ป่าตอง ฿1,100 วันเดย์ภูเก็ต ฿3,200 ภูเก็ต→เขาหลัก ฿3,200 ตรงเวลา ปลอดภัย',
  keywords: 'รับส่งสนามบินภูเก็ต, ภูเก็ต airport transfer, รถรับส่งสนามบิน HKT, รถรับส่งป่าตอง, รถรับส่งเขาหลัก, phuket airport transfer',
  openGraph: {
    title: `รับส่งสนามบินภูเก็ต | ${SITE_NAME}`,
    description: 'บริการรถรับส่งสนามบินภูเก็ต พร้อมคนขับ ราคาเหมาจ่าย เริ่มต้น ฿1,100 ตรงเวลา ปลอดภัย',
    url: `${SITE_URL}/phuket-airport-transfer`,
    type: 'website',
    locale: 'th_TH',
    siteName: SITE_NAME,
  },
  alternates: { canonical: `${SITE_URL}/phuket-airport-transfer` },
}

const ROUTES = [
  { service: 'สนามบินภูเก็ต → ป่าตอง', price: '1,100' },
  { service: 'วันเดย์ภายในภูเก็ต (10 ชม.)', price: '3,200' },
  { service: 'ภูเก็ต → เขาหลัก', price: '3,200' },
]
...
const FAQ = [
  { q: 'คนขับจะรอรับที่ไหน?', a: 'คนขับจะรอพร้อมป้ายชื่อที่ประตูทางออกผู้โดยสารขาเข้า สนามบินภูเก็ต (HKT)' },
  ...
  { q: 'วันเดย์ภูเก็ตไปไหนได้บ้าง?', a: 'ไปได้ทั่วเกาะภูเก็ต เช่น หาดป่าตอง กะรน กะตะ วัดฉลอง แหลมพรหมเทพ โอลด์ทาวน์ ภายใน 10 ชม.' },
  { q: 'ภูเก็ตไปเขาหลักใช้เวลานานแค่ไหน?', a: 'ประมาณ 1.5-2 ชม. ขึ้นอยู่กับสภาพการจราจร' },
]

export default function PhuketAirportTransferPage() {
  const faqJsonLd = {
  ...
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'บริการรับส่งสนามบินภูเก็ต — SunSeaRapidsCare',
    description: 'บริการรถรับส่งสนามบินภูเก็ต พร้อมคนขับ ราคาเหมาจ่าย ตรงเวลา ปลอดภัย',
  ...
  return (
    <main style={{ background: 'var(--navy-900)', minHeight: '100vh' }}>
      ...
      <div style={{ paddingTop: 80 }}>
        <Breadcrumb items={[{ label: 'รับส่งสนามบิน', href: '/airport-transfer' }, { label: 'ภูเก็ต' }]} />

        <section style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px 120px' }}>
          {/* Header */}
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <span style={{ color: '#C6A75E', fontSize: 13, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', display: 'block', marginBottom: 12 }}>Phuket Airport Transfer</span>
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 700, color: '#FFFFFF', margin: 0 }}>
              บริการรถรับส่ง<span className="gold-shimmer">สนามบินภูเก็ต</span> พร้อมคนขับ
            </h1>
          ...
          <div style={{ marginBottom: 60, overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, minWidth: 400 }}>
              <thead>
                <tr>
                  {['บริการ / เส้นทาง', 'ราคา'].map((h, i) => (
                    <th key={i} style={{ padding: '16px 20px', background: '#12263A', color: '#C6A75E', fontSize: 13, fontWeight: 700, textAlign: 'left', borderBottom: '2px solid rgba(198,167,94,0.2)', ...(i === 0 ? { borderRadius: '12px 0 0 0' } : { borderRadius: '0 12px 0 0' }) }}>
                      {h}
                    </th>
                  ))}
                </tr>
          ...
          <div style={{ textAlign: 'center', padding: '48px 24px', background: '#12263A', borderRadius: 18, border: '1px solid rgba(198,167,94,0.1)' }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, color: '#FFFFFF', marginBottom: 12 }}>
              จองรถรับส่งสนามบินภูเก็ตวันนี้
            </h2>
